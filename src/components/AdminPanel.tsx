...
import { Shield, Users, Plus, Edit, Trash2, Eye, EyeOff, Key, UserCheck, AlertTriangle, CheckCircle } from 'lucide-react';
...
const AdminPanel: React.FC = () => {
  ...
  const loadUsers = async () => {
    try {
      setLoading(true);
      console.log('🔄 Loading users from MySQL database...');
